...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var barLayout = {
      title: "Top 10 Bacteria Cultues Found",
      xaxis: {title: ""},
      yaxis: {title: "OTU IDs",
        tickmode: "array",
      ...
      annotations: [{
        ...
        y: -0.25,
        yanchor: 'center',
        text: 'The bar chart shows the 10 most common bacteria species <br>within your belly button from greatest to least',
        showarrow: false
      }]
    };
...
// d3.json("samples.json").then((data) => {
    ...
    var washingFreq = parseFloat(metadataArray[0].wfreq);
    ...
    var gaugeLayout = { 
      ...
      annotations: [{
          ...
          y: 0,
          yanchor: 'center',
          text: "This gauge shows the number of times you <br>washed your belly button each week",
          showarrow: false
        }]
    };
